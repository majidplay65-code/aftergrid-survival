...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۲۷` پیاده‌سازی‌شده (۰.۲۸.۰) — تست دستی کاربر برای ۷–۲۷ هنوز انجام نشده.
...
| ۲۶ | **میز ساخت** — ایستگاه نزدیک ژنراتور | ✅ پیاده شد (۰.۲۷.۰؛ تست دستی: در انتظار) |
| ۲۷ | **رادیو شرق** — سیگنال با قراضه | ✅ پیاده شد (۰.۲۸.۰؛ تست دستی: در انتظار) |

**اولویت بعدی:** تست دستی ۷–۲۷ در Godot 4.7.2. بدون merge تا «من شخصاً در Godot تست کردم».
...
13. شرق نقشه حیاط صنعتی است (انبار، کانتینر، سوله، رادیو) با آیتم و Enemy4.
