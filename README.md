...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۲۰` پیاده‌سازی‌شده (۰.۲۱.۰) — تست دستی کاربر برای ۷–۲۰ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۲۰ در Godot؛ سپس فاز ۲۱ (چرخه شب). بدون merge تا «من شخصاً در Godot تست کردم».
