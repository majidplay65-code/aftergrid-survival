...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۲۳` پیاده‌سازی‌شده (۰.۲۴.۰) — تست دستی کاربر برای ۷–۲۳ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۲۳ در Godot؛ سپس فاز ۲۴ (حافظه دشمن). بدون merge تا «من شخصاً در Godot تست کردم».
