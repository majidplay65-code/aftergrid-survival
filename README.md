...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۲۶` پیاده‌سازی‌شده (۰.۲۷.۰) — تست دستی کاربر برای ۷–۲۶ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۲۶ در Godot؛ سپس فاز ۲۷ (رادیو شرق). بدون merge تا «من شخصاً در Godot تست کردم».
