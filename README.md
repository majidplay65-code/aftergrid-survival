...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۲۴` پیاده‌سازی‌شده (۰.۲۵.۰) — تست دستی کاربر برای ۷–۲۴ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۲۴ در Godot؛ سپس فاز ۲۵ (سقوط). بدون merge تا «من شخصاً در Godot تست کردم».
