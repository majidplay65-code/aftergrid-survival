...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۳` انجام شده + بازطراحی بصری محیط (بلوک شهری، تکسچر، نورپردازی گرگ‌ومیش، چراغ‌قوه). فاز بعدی: `۴` (Inventory & Crafting).
...
| ۳.۵ | Environment & Atmosphere — بلوک شهری پس از فروپاشی، تکسچر، مه/نور، چراغ‌قوه | ✅ انجام شد |
