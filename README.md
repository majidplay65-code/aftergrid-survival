...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۱۵` پیاده‌سازی‌شده (۰.۱۶.۰) — تست دستی کاربر برای ۷–۱۵ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی فازهای ۷–۱۵ توسط کاربر (طبق DoDهای زیر). بدون merge تا «من شخصاً در Godot تست کردم».
