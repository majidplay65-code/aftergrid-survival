...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۲۱` پیاده‌سازی‌شده (۰.۲۲.۰) — تست دستی کاربر برای ۷–۲۱ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۲۱ در Godot؛ سپس فاز ۲۲ (برد شب). بدون merge تا «من شخصاً در Godot تست کردم».
