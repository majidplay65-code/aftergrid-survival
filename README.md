...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۱۸` پیاده‌سازی‌شده (۰.۱۹.۰) — تست دستی کاربر برای ۷–۱۸ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۱۸ در Godot؛ سپس فاز ۱۹ (در + فضای داخلی). بدون merge تا «من شخصاً در Godot تست کردم».
