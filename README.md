...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۲۲` پیاده‌سازی‌شده (۰.۲۳.۰) — تست دستی کاربر برای ۷–۲۲ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۲۲ در Godot؛ سپس فاز ۲۳ (پناه). بدون merge تا «من شخصاً در Godot تست کردم».
