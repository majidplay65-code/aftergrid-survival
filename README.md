...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۱۹` پیاده‌سازی‌شده (۰.۲۰.۰) — تست دستی کاربر برای ۷–۱۹ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی ۷–۱۹ در Godot؛ سپس فاز ۲۰ (یک کیف). بدون merge تا «من شخصاً در Godot تست کردم».
