...
- **موتور:** Godot 4.7
- **وضعیت فعلی:** فازهای `۰` تا `۶` کامل و **تأیید**شده با CI + فازهای `۷` تا `۱۷` پیاده‌سازی‌شده (۰.۱۸.۰) — تست دستی کاربر برای ۷–۱۷ هنوز انجام نشده.
...
**اولویت بعدی:** تست دستی فازهای ۷–۱۷ توسط کاربر (طبق DoDهای زیر). بدون merge تا «من شخصاً در Godot تست کردم».
